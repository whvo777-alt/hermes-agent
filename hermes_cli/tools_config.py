...
CONFIGURABLE_TOOLSETS = [
    ...
    ("coo",             "🏢 COO Orchestration",        "coo_orchestrate — CEO approval planning"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "video_gen", "x_search", "coo"}
